...
class RacecarGymEnv(gym.Env):
    ...
    def __init__(self,
        ...
        self._seed()
        #self.reset()
        observationDim = 4 #len(self.getExtendedObservation())
    ...
    def getExtendedObservation(self):
        ...
        self._observation.extend([np.array(ballPosInCar[0], dtype=np.float32),\
                                  np.array(ballPosInCar[1], dtype=np.float32)])
        return self._observation
    ...
    def _step(self, action):
        ...
        if (self._isDiscrete):
            ...
            brake = 0
            realaction = [forward, steer, brake]
        else:
            realaction = action
