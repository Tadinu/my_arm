...
//#define MY_ARM_GAZEBO_TRANSPORT (1)
...
public:
#ifdef MY_ARM_GAZEBO_TRANSPORT
    VoxCad(QWidget *parent, QMutex &m,gazebo::common::Image &img, Qt::WindowFlags flags = 0);
#else
    VoxCad(QWidget *parent = nullptr, Qt::WindowFlags flags = 0);
#endif
    ~VoxCad();
...
public slots:
    ...
    void updateGazeboCamera();
public:
    void initGazeboCamera(ir::CameraPtr camera);
    void runGazeboCamera(std::vector<ir::CameraPtr> cameras);
    void updateGazeboScenes();
#endif
