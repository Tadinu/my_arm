...
//        }
    ...
    Row {
        ...
        K3DButton {
            ...
            _btnNormalSource  : GEORC.ICON.MAIN_WINDOW_ABOUT_BUTTON
            _btnHoveredSource : GEORC.ICON.MAIN_WINDOW_ABOUT_BUTTON_HOVER
            _btnPressedSource : GEORC.ICON.MAIN_WINDOW_ABOUT_BUTTON
            _btnSourceSize    : _mainContentItem.width/45

            opacity: gbMainAppWindow._currentMenuPage === 0 ? 1 : 0
            enabled: opacity === 1
            Behavior on opacity {
                PropertyAnimation { duration: GEORC.ANIMATION_DURATION.OPACITY * 2 }
            }
        ...
        K3DButton {
            ...
            _btnType: _CBUTTON_TYPE_ICON_ONLY
            _btnNormalSource  : GEORC.ICON.MAIN_WINDOW_MINIMIZE_BUTTON
            _btnHoveredSource : GEORC.ICON.MAIN_WINDOW_MINIMIZE_BUTTON_HOVER
            _btnPressedSource : GEORC.ICON.MAIN_WINDOW_MINIMIZE_BUTTON
            _btnSourceSize : _mainContentItem.width/45
            onClicked: {
        ...
        K3DButton {
            ...
            _btnType: _CBUTTON_TYPE_ICON_ONLY
            _btnNormalSource  : GEORC.ICON.MAIN_WINDOW_CLOSE_BUTTON
            _btnHoveredSource : GEORC.ICON.MAIN_WINDOW_CLOSE_BUTTON_HOVER
            _btnPressedSource : GEORC.ICON.MAIN_WINDOW_CLOSE_BUTTON
            _btnSourceSize : _mainContentItem.width/45
    ...
    K3DRectangle {
        ...
        color:  "#2B2B2B" // GEORC.COLOR.TRANSPARENT
        //_backgroundSource : GEORC.BACKGROUND.MAIN_WINDOW_BACKGROUND
        clip: true
...
//        if(gbMainNotificationBar._isBeingShown) {
//            var answerCancel = (gbMainNotificationBar._buttonType === GEORC.NOTIFY_BUTTON_TYPE.STANDARD) ?
...
//            mainMenuPanelView.goMainMenuPanelPage();
    ...
    */
    ...
    //        source: GEORC.ICON.QUICK_PARTICLE
    //        color: "white"
    //        alpha: 1.0
    //        colorVariation: 0
    //        groups: ["A"]
