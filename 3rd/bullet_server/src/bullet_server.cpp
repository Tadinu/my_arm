...
#include "bullet_server/AddCompoundRequest.h"
#include "bullet_server/AddCompoundResponse.h"
...
#if 0
void BulletServer::makeSoftBody(const bullet_server::SoftBody::ConstPtr& msg)
{
    // -------------------------------------------------------------------------
    // -------------------------------------------------------------------------

    //if (ros::service::call("add_compound", &BulletServer::addCompound))
...
void BulletServer::constraintCallback(const bullet_server::Constraint::ConstPtr& msg)
{
    ...
    {
        ROS_WARN_STREAM("can't have constraint on same body " << msg->body_a << " " << msg->body_b);
        return;
    }
