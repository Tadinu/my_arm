...
TextInput {
    ...
    font.pixelSize : thisTextInput._fontSize
    font.family    : customFont.name
    font.bold      : thisTextInput._fontBold
    ...
    property real _bottomMargin : _topMargin
    ...
    cursorVisible     : false
    Keys.onPressed: {
        //print('TEXT INPUT ITEM KEY:', event.key);
        //-------------------------------------------------------------------------------
        switch(event.key) {
        case Qt.Key_CapsLock:                               // [CAPSLOCK] ---------------
            event.accepted = true;
            break;
        default:
