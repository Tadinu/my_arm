...
public:
    ...
    void updateSourcePosition(double t){ position.x = basePosition.x + ampx*sin(2*VOXEL_PI*freqx*t); position.y = basePosition.y + ampy*sin(2*VOXEL_PI*freqy*t); position.z = basePosition.z + ampz*sin(2*VOXEL_PI*freqz*t);}
