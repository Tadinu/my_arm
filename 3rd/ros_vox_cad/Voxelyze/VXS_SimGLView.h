...
enum ViewColor {
	...
	RVC_GROWTH_RATE, //Color coded growth rate parameters
	...
	RVC_STIFF_PLAST_RATE, //!< Color coded stiffness plasticity rate
	RVC_STIMULUS //!< Color coded environmental stimuli
};
