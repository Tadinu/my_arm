...
#include "RobotGazeboAdapter.h"

RobotGazeboAdapter* RobotGazeboAdapter::_instance = nullptr;
RobotGazeboAdapter* RobotGazeboAdapter::getInstance()
{
    if(_instance == nullptr) {
        _instance = new RobotGazeboAdapter();
    }
...
RobotGazeboAdapter::RobotGazeboAdapter():
...
void RobotGazeboAdapter::deleteInstance()
{
    delete _instance;
    _instance = nullptr;
}

void RobotGazeboAdapter::initDart(int argc, char* argv[])
{
#if 1 // Ducta
