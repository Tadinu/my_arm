// Generated by gencpp from file my_arm/leapros.msg
// DO NOT EDIT!


#ifndef MY_ARM_MESSAGE_LEAPROS_H
#define MY_ARM_MESSAGE_LEAPROS_H
...
struct leapros_
{
  ...
  typedef boost::shared_ptr< ::my_arm::leapros_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::my_arm::leapros_<ContainerAllocator> const> ConstPtr;

}; // struct leapros_

typedef ::my_arm::leapros_<std::allocator<void> > leapros;

typedef boost::shared_ptr< ::my_arm::leapros > leaprosPtr;
typedef boost::shared_ptr< ::my_arm::leapros const> leaprosConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::my_arm::leapros_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::my_arm::leapros_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::my_arm::leapros_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::my_arm::leapros_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::my_arm::leapros_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::my_arm::leapros_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::my_arm::leapros_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::my_arm::leapros_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::my_arm::leapros_<ContainerAllocator> >
{
  ...
  static const char* value(const ::my_arm::leapros_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe37447f7532c765dULL;
  static const uint64_t static_value2 = 0x6c587f418fd5dd03ULL;
};

template<class ContainerAllocator>
struct DataType< ::my_arm::leapros_<ContainerAllocator> >
{
  static const char* value()
  {
    return "my_arm/leapros";
  }
...
template<class ContainerAllocator>
struct Definition< ::my_arm::leapros_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::my_arm::leapros_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::my_arm::leapros_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::my_arm::leapros_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // MY_ARM_MESSAGE_LEAPROS_H
